...
(function ($) {
    ...
    function createWholeCalendar(settings, $this) {
        ...
        var domSkeleton = '<div class="jqyc" ><div class="jqyc-year-chooser border-top border-bottom row align-items-center" data-current-year="' + year + '">' +
            ...
            '   <button type="button" class="btn btn-sm jqyc-prev-year jqyc-change-year" data-year="' + (year - 1) + '"><i class="fas fa-caret-left"></i> </button>' +
            '</div>' +
            '<div class="jqyc-year">' + year + '</div>' +
            '<div class="text-center text-muted jqyc-year">' + (year + 1) + '</div>' +
            '<div class="' + colColXs2 + '">' +
            '   <button type="button" class="btn btn-sm jqyc-next-year jqyc-change-year" data-year="' + (year) + '"><i class="fas fa-caret-right"></i></button>' +
            '</div>' +
            '</div>' +
